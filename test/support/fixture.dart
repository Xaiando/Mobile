...
const curriculumSeed = <String>[
  ...
  "INSERT INTO certifications VALUES ('WSET_L1', 'WSET', 1, 'WSET Level 1', NULL, NULL, 0, 'certification', NULL), ('WSET_L2', 'WSET', 2, 'WSET Level 2', 'WSET_L1', NULL, 0, 'certification', NULL), ('WSET_L3', 'WSET', 3, 'WSET Level 3', 'WSET_L2', 'tg_wset_sat_l3', 1, 'certification', NULL), ('CMS_INTRODUCTORY', 'CMS', 1, 'CMS Introductory', NULL, NULL, 0, 'certification', NULL), ('CMS_CERTIFIED', 'CMS', 2, 'CMS Certified', 'CMS_INTRODUCTORY', 'tg_cms_dtm_certified', 1, 'certification', NULL)",
  ...
  "INSERT INTO relation_types VALUES ('LOCATED_IN', 'is located in', 'contains', 'many', 1, 0, 'geography', NULL, 0), ('HAS_BERRY_COLOUR', 'has berry colour', 'is the berry colour of', 'one', 0, 0, 'viticulture', NULL, 0), ('PERMITS_PRINCIPAL_GRAPE', 'permits the principal grape', 'is a principal grape of', 'many', 0, 0, 'geography', 'HAS_BERRY_COLOUR', 0), ('HAS_SOIL', 'has soil', 'is the soil of', 'many', 0, 0, 'viticulture', NULL, 0), ('MIN_AGEING', 'requires minimum ageing of', 'is the minimum ageing of', 'one', 0, 0, 'geography', NULL, 0)",
  ...
  "INSERT INTO question_templates VALUES ('qt_ppg_fwd_mcq', 'PERMITS_PRINCIPAL_GRAPE', 'forward', 'mcq', 'en', 'Which grape variety is the principal grape of {subject.name}?', '', NULL), ('qt_soil_fwd_flashcard', 'HAS_SOIL', 'forward', 'flashcard', 'en', 'What is the characteristic soil of {subject.name}?', '', NULL)",
