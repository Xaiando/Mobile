...
class UserDataRewrites extends Table
    with TableInfo<UserDataRewrites, UserDataRewritesData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  UserDataRewritesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return UserDataRewritesData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
...
class UserDataRewritesData extends DataClass
    implements Insertable<UserDataRewritesData> {
  final int id;
  final String startedAt;
  const UserDataRewritesData({required this.id, required this.startedAt});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  factory UserDataRewritesData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  UserDataRewritesData copyWith({int? id, String? startedAt}) =>
      UserDataRewritesData(
        id: id ?? this.id,
        startedAt: startedAt ?? this.startedAt,
      );
  UserDataRewritesData copyWithCompanion(UserDataRewritesCompanion data) {
    return UserDataRewritesData(
      id: data.id.present ? data.id.value : this.id,
      startedAt: data.startedAt.present ? data.startedAt.value : this.startedAt,
    );
  ...
  @override
  String toString() {
    return (StringBuffer('UserDataRewritesData(')
          ..write('id: $id, ')
          ..write('startedAt: $startedAt')
          ..write(')'))
        .toString();
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is UserDataRewritesData &&
          other.id == this.id &&
          other.startedAt == this.startedAt);
}

class UserDataRewritesCompanion extends UpdateCompanion<UserDataRewritesData> {
  final Value<int> id;
  final Value<String> startedAt;
  ...
  static Insertable<UserDataRewritesData> custom({
    Expression<int>? id,
    Expression<String>? startedAt,
  }) {
    return RawValuesInsertable({
...
class UserSettingsData extends DataClass
  ...
  UserSettingsData copyWith({String? name, String? value, String? updatedAt}) =>
      UserSettingsData(
        name: name ?? this.name,
...
class QuestionFlags extends Table
    with TableInfo<QuestionFlags, QuestionFlagsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  QuestionFlagsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return QuestionFlagsData(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
...
class QuestionFlagsData extends DataClass
    implements Insertable<QuestionFlagsData> {
  final String id;
  final String knowledgeItemId;
  final String? questionTemplateId;
  final String reason;
  ...
  factory QuestionFlagsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  QuestionFlagsData copyWithCompanion(QuestionFlagsCompanion data) {
    return QuestionFlagsData(
      id: data.id.present ? data.id.value : this.id,
      knowledgeItemId: data.knowledgeItemId.present
          ? data.knowledgeItemId.value
  ...
  @override
  String toString() {
    return (StringBuffer('QuestionFlagsData(')
          ..write('id: $id, ')
          ..write('knowledgeItemId: $knowledgeItemId, ')
          ..write('questionTemplateId: $questionTemplateId, ')
          ..write('reason: $reason, ')
...
class QuestionFlagsCompanion extends UpdateCompanion<QuestionFlagsData> {
  final Value<String> id;
  final Value<String> knowledgeItemId;
  final Value<String?> questionTemplateId;
  ...
  QuestionFlagsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       reason = Value(reason),
       createdAt = Value(createdAt);
  static Insertable<QuestionFlagsData> custom({
    Expression<String>? id,
    Expression<String>? knowledgeItemId,
    Expression<String>? questionTemplateId,
